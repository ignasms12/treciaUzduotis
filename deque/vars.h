...
void splitOutput(std::deque<Studentas> &, std::deque<Studentas>& , std::deque<Studentas>& );

void print(std::deque<Studentas> , std::deque<Studentas>, std::deque<Studentas>, int );
