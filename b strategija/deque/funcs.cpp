...
void splitOutput(std::deque<Studentas> &vektoriux, std::deque<Studentas> &vargsiukai){
	int kitasCount = 0;
...
void print(std::deque<Studentas> printeris, std::deque<Studentas> vargsiukai, int pasirinkimas){
	std::cout << std::endl;
	int hehehey;
